...
const TransferForm = ({accounts,setAccounts,currentAccount,setCurrentAccount,balance, receiverUsername, setReceiverUsername, transferAmount, setTransferAmount}:TransferFormData) => {
